...
public class OrdersController extends BaseController{
    ...
    @ApiOperation(value = "用于支付中心回调本地订单修改订单状态", notes = "用于支付中心回调本地订单修改订单状态", httpMethod = "POST")
    @PostMapping("/notifyMerchantOrderPaid")
    public IMOOCJSONResult notifyMerchantOrderPaid(
            @ApiParam(name = "订单Id", value = "订单Id", required = true)
    ...
    @ApiOperation(value = "用户商家发货后改变订单状态", notes = "用户商家发货后改变订单状态", httpMethod = "POST")
    @PostMapping("/updateDeliverOrderStatus")
    public IMOOCJSONResult updateDeliverOrderStatus (
            @ApiParam(name = "订单Id", value = "订单Id", required = true)
            @RequestParam String merchantOrderId) {
